...
export interface PublicArticleSummary{id:number;columnId:number;columnName:string;columnAlias:string;title:string;source:string;articleType:ArticleType;externalUrl:string|null;publishDate:string|null;pinned:boolean;recommended:boolean;sortOrder:number;coverResourceId:number|null}
