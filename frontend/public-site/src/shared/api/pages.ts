...
export interface PublicPage{
  ...
  structuredContent:PageStructuredContent|null
  /** Deprecated compatibility projection for legacy Page renderer identities. */
  renderMode:PageRenderMode|null
  embedUrl:string|null
  canonicalUrl:string
  group:PublicPageGroup|null
  breadcrumbs:Array<{title:string;href:string|null}>
}
