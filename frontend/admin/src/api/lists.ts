export type CmsListItemType='LINK'|'IMAGE_LINK'|'TEXT'
export interface CmsListDefinition{id:number;code:string;name:string;groupCode:string;itemType:CmsListItemType;description:string;sortOrder:number;enabled:boolean;system:boolean}
...
export interface PublicCmsList{id:number;code:string;name:string;groupCode:string;itemType:CmsListItemType;items:CmsListItem[]}
export interface CmsListDraft{code:string;name:string;groupCode:string;itemType:CmsListItemType;description:string;sortOrder:number;enabled:boolean;system:boolean}
