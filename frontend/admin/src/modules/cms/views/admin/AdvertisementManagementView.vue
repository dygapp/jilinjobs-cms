...
const adForm = reactive<AdvertisementDraft>({ title: '', imagePath: '', url: null, openMode: null, startAt: null, endAt: null, sortOrder: 0, enabled: true })
...
function addAd() { editingAd.value = null; Object.assign(adForm, { title: '', imagePath: '', url: null, openMode: null, startAt: null, endAt: null, sortOrder: 0, enabled: true }); adDialog.value = true }
