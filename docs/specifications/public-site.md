...
- 通知公告、就业动态、快速导航、招聘公告等多列小板块使用连续卡片标题轮廓：顶部强调色横条必须直接与左右竖向边框连接，不得在强调色横条与外框之间出现白色间隙；
- 小板块标题文字不恢复旧的文字下划线强调；顶部左右圆角属于允许的视觉细节，可实现但不作为阻塞验收项；
...
- Main 首页通知公告、就业动态、快速导航、招聘公告等多列小板块的顶部强调色横条与左右竖向边框连续连接，不出现 inset / white gap，且不恢复标题文字下划线；
