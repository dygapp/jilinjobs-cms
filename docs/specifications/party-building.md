...
- Footer 与原站机构联系、版权、ICP备案和公安备案信息保持同一内容口径，但保持党员之家自有红色 DOM/CSS；
- 公安备案使用与主站相同的稳定备案图标资源；
- Desktop / Mobile 响应式。
...
- 党员之家首页顶部由独立 CmsList 图片轮播驱动，且配置 URL 的轮播项可正常跳转；
- `/party/column/{alias}` 支持分页和内链/外链混合内容；
- `/party/article/{id}` 只展示党员之家站内文章，并拒绝非党员之家文章；
- 党员之家 Shell 与 Main Shell / CSS 隔离；Footer 共享信息口径与稳定备案资源，但不复用 Main Footer DOM/CSS；
