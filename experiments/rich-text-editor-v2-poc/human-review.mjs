...
const jodit=Jodit.make('#jodit-editor',{language:'zh_cn',height:430,askBeforePasteFromWord:false,defaultActionOnPasteFromWord:'insert_as_html',defaultActionOnPaste:'insert_as_html'});jodit.value=INITIAL_HTML;
