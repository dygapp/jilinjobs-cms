...
当前迭代聚焦**中心主站，以及下一阶段立即进入建设的中心党建公开前端基础框架**。中心党建的详细内容、栏目结构、完整视觉收敛和专属后台能力只按本仓库后续 Requirement / Specification 明确范围推进；不得从其他项目、其他会话、个人记忆、惯例或实现便利性中推导、补充或扩大本项目的产品范围。
